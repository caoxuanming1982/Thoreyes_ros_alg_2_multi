...
void test_video(std::string video_path, std::string channel_cfg_path, int max_frame = 7500)
{ 
    //目标检测
    ...
    //车牌检测
    std::string license_plate_detection_root_dir = "/home/vensin/workspace_sun/alg_module_license_plate_detection/requirement";
    std::string license_plate_detection_dl_file = "/home/vensin/workspace_sun/alg_module_license_plate_detection/build/libalg_module_license_plate_detection_share.so";
    ...
    //车牌识别
    std::string license_plate_recognition_root_dir = "/home/vensin/workspace_sun/alg_module_license_plate_recognition/requirement";
    std::string license_plate_recognition_dl_file = "/home/vensin/workspace_sun/alg_module_license_plate_recognition/build/libalg_module_license_plate_recognition_share.so";
    ...
    //检测与追踪
    std::string detect_tracking_root_dir = "/home/vensin/workspace_sun/alg_module_detect_tracking/requirement";
    std::string detect_tracking_dl_file  = "/home/vensin/workspace_sun/alg_module_detect_tracking/build/libalg_module_detect_tracking_share.so";
...
int main(int argc, char *argv[])
{
    ...
    test_video(
        "/home/vensin/workspace_sun/test_data/车流统计/06010003343000000.mp4", 
        "/home/vensin/workspace_sun/test_data/车流统计/06010003343000000.xml", 
        1000);
}
